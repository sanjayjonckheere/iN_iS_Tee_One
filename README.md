...
![Style01](https://user-images.githubusercontent.com/72076380/111522393-8437fc00-875a-11eb-9fdd-b1f3102a30cc.png)
...
The class of [Deep Neural Networks](https://arxiv.org/pdf/1605.07678.pdf?source=post_page---------------------------) that are most powerful in image processing tasks are called [Convolutional Neural Networks](https://towardsdatascience.com/a-comprehensive-guide-to-convolutional-neural-networks-the-eli5-way-3bd2b1164a53) (CNN or ConvNet). Convolutional = a form or shape that is folded in curved or tortuous windings → the convolutions of the intestines or one of the irregular ridges on the surface of the brain and especially of the cerebrum of higher mammals → merriam-webster.com.
